...
- (void)moveViewWithGesture:(UIPanGestureRecognizer *)panGes
{
    ...
    if (panGes.state == UIGestureRecognizerStateChanged)
    {
        ...
        CGAffineTransform transS = CGAffineTransformMakeScale(1, 1);
        CGAffineTransform transT = CGAffineTransformMakeTranslation(transX+60, 0);
...
- (CGAffineTransform)transformWithDirection:(RMoveDirection)direction
{
    ...
    CGAffineTransform transT = CGAffineTransformMakeTranslation(translateX, 1);
